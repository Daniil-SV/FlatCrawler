...
struct Clan::Traits {
  using type = Clan;
  static auto constexpr Create = CreateClan;
};
...
inline ::flatbuffers::Offset<Clan> CreateClanDirect(
  ...
  return MyGame::Sample::CreateClan(
      _fbb,
      name__);
}
...
struct Monster FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const MyGame::Sample::Clan *clan() const {
    return GetPointer<const MyGame::Sample::Clan *>(VT_CLAN);
  }
  int16_t mana() const {
  ...
  const MyGame::Sample::Vec3 *world_pos() const {
    return GetStruct<const MyGame::Sample::Vec3 *>(VT_WORLD_POS);
  }
  const ::flatbuffers::String *name() const {
    return GetPointer<const ::flatbuffers::String *>(VT_NAME);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<MyGame::Sample::Vec3>(verifier, VT_WORLD_POS, 4) &&
           VerifyOffset(verifier, VT_NAME) &&
           verifier.VerifyString(name()) &&
...
struct MonsterBuilder {
  ...
  void add_clan(::flatbuffers::Offset<MyGame::Sample::Clan> clan) {
    fbb_.AddOffset(Monster::VT_CLAN, clan);
  }
  void add_mana(int16_t mana) {
    fbb_.AddElement<int16_t>(Monster::VT_MANA, mana, 150);
  }
  void add_hp(uint32_t hp) {
    fbb_.AddElement<uint32_t>(Monster::VT_HP, hp, 0);
  }
  void add_stamina(float stamina) {
    fbb_.AddElement<float>(Monster::VT_STAMINA, stamina, 0.0f);
  }
  void add_world_pos(const MyGame::Sample::Vec3 *world_pos) {
    fbb_.AddStruct(Monster::VT_WORLD_POS, world_pos);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
...
inline ::flatbuffers::Offset<Monster> CreateMonster(
    ...
    ::flatbuffers::Offset<MyGame::Sample::Clan> clan = 0,
    int16_t mana = 150,
    uint32_t hp = 0,
    float stamina = 0.0f,
    const MyGame::Sample::Vec3 *world_pos = nullptr,
    ::flatbuffers::Offset<::flatbuffers::String> name = 0,
  ...
  builder_.add_name(name);
  builder_.add_world_pos(world_pos);
...
inline bool VerifyMonsterBuffer(
  ...
  return verifier.VerifyBuffer<MyGame::Sample::Monster>(MonsterIdentifier());
}

inline bool VerifySizePrefixedMonsterBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MyGame::Sample::Monster>(MonsterIdentifier());
}
